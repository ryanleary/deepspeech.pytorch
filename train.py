...
parser.add_argument('--rnn_type', default='rnn', help='Type of the RNN. rnn|gru|lstm are supported')
...
parser.set_defaults(cuda=False, silent=False, checkpoint=False, visdom=False, augment=False, sortaGrad=True)
