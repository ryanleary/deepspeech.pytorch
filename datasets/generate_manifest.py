...
parser.add_argument('--max-duration', default=None, type=int, required=True,
                    help='Prunes training samples longer than the max duration (given in seconds, default None)')
args = parser.parse_args()

if __name__ == '__main__':
    create_manifest(args.data_path, args.output_file, min_duration=args.min_duration, max_duration=args.max_duration)
